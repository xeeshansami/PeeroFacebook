...
public class Launch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Launch.this, WebForm.class));
            }
        });
        init();
    ...
    private void init() {
        ...
        howtoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                preferenceManager = new PreferenceManager(Launch.this);
        /*============================*/
                if (!preferenceManager.FirstLaunch()) {
                    preferenceManager.setFirstTimeLaunch(true);
                    startActivity(new Intent(Launch.this, Sliders.class));
                    finish();
                }
            }
        });
...
//        }
        ...
        obj_adapter = new Adapter_VideoFolder(getApplicationContext(), al_video, Launch.this);
